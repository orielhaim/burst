...
function model(
	...
	return {
		...
		supportGrip: [0, -0.04, -length * 0.45],
		obstruction: {
...
export const smgDefinition = WeaponRegistry.register({
	...
	recoil: {
		hip: { cameraPitch: 0.0036, cameraYaw: 0.0027, visualKick: 1.92 },
		ads: { cameraPitch: 0.0027, cameraYaw: 0.0018, visualKick: 1.44 },
	},
	motion: {
...
export const sniperDefinition = WeaponRegistry.register({
	...
	recoil: {
		hip: { cameraPitch: 0.027, cameraYaw: 0.0054, visualKick: 8.16 },
		ads: { cameraPitch: 0.02025, cameraYaw: 0.0036, visualKick: 6.72 },
	},
	motion: {
		...rifleDefinition.motion,
		inertia: 1.65,
...
export const shotgunDefinition = WeaponRegistry.register({
	...
	recoil: {
		hip: { cameraPitch: 0.018, cameraYaw: 0.0045, visualKick: 6.72 },
		ads: { cameraPitch: 0.0135, cameraYaw: 0.0027, visualKick: 5.28 },
	},
	motion: {
		...rifleDefinition.motion,
		inertia: 1.2,
...
export const knifeDefinition = WeaponRegistry.register<MeleeDefinition>({
	...
	motion: { ...rifleDefinition.motion, inertia: 0.4, response: 42 },
	viewModel: {
		// Blade is modeled along -Z. Hold it lower-right, angled slightly up
		// and across — not rolled so far that the grip reads as sideways.
		hipPose: {
			position: [0.28, -0.24, -0.42],
			rotation: [0.2, -0.45, -0.55],
		},
		adsPose: {
			position: [0.26, -0.22, -0.4],
			rotation: [0.16, -0.4, -0.48],
		},
		primaryGrip: [0, 0, 0.06],
		supportGrip: [-0.28, -0.12, 0.18],
		loadingPoint: [0, 0, 0.06],
		muzzlePosition: [0, 0, -0.28],
		opticMount: { position: [0, 0, 0], rotation: [0, 0, 0] },
		obstruction: {
			probes: [
				{ position: [0, 0, 0.08], radius: 0.05 },
				{ position: [0, 0, -0.16], radius: 0.04 },
			],
			returnSpeed: 16,
			fullTiltRetraction: 0.4,
			maxDisplacement: 0.1,
		...
		parts: [
			{
				type: "box",
				size: [0.038, 0.045, 0.14],
				position: [0, 0, 0.04],
				material: "grip",
			},
			{
				type: "box",
				size: [0.09, 0.018, 0.022],
				position: [0, 0, -0.04],
				material: "body",
			},
			{
				type: "box",
				size: [0.032, 0.01, 0.26],
				position: [0, 0, -0.17],
				rotation: [0, 0.04, 0],
				material: "accent",
			},
